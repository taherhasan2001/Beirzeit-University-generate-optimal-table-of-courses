...
class display():
    def __init__(self, DectoUse,flagReducedays,flagreduceTime,flagReduceStartTime,flagReduceEndTime):
        self.pointer = 0
        ...
        self.text = Label(self.window, text="hello", font=("Arial", 24), fg="black", bg='white')
        self.text.place(x=800, y=750)
    ...
    def show(self,dec = None): #change_l_lf_and_show
        ...
        self.text.config(text=f"{self.pointer+1}/{len(self.Dec)}")
